...
assign vx1_tx_buf_vs[i]   =  vx1_tx_in_de[i] ? 0 : SYNC_POLARITY ? ~vx1_tx_in_vs[i] : vx1_tx_in_vs[i];    
end
endgenerate
...
assign vx1_rx_out_hs[i]    =  SYNC_POLARITY ? vx1_rx_buf_de[i] ? 0 : ~vx1_rx_buf_hs[i] : vx1_rx_buf_de[i] ? 0 : vx1_rx_buf_hs[i];
assign vx1_rx_out_vs[i]    =  SYNC_POLARITY ? vx1_rx_buf_de[i] ? 0 : ~vx1_rx_buf_vs[i] : vx1_rx_buf_de[i] ? 0 : vx1_rx_buf_vs[i];    
end
endgenerate
...
assign  tx_mmcm_lock = ~(vx1_rst | ~gtwiz_reset_tx_done_in);
...
assign vx1_tx_de    =  vx1_tx_in_de;
assign vx1_tx_hs    =  vx1_tx_in_hs;
assign vx1_tx_vs    =  vx1_tx_in_vs;
assign vx1_tx_data  =  vx1_tx_in_data;
