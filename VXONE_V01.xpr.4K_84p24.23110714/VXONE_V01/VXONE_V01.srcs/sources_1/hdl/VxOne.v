...
assign vx1_tx_buf_hs[i]   =  vx1_tx_in_de[i] ? 0 : SYNC_POLARITY ? ~vx1_tx_in_hs[i] : vx1_tx_in_hs[i];    
...
assign vx1_rx_out_hs[i]    =  SYNC_POLARITY ? vx1_rx_buf_de[i] ? 0 : ~vx1_rx_buf_hs[i] : vx1_rx_buf_de[i] ? 1 : vx1_rx_buf_hs[i];
assign vx1_rx_out_vs[i]    =  SYNC_POLARITY ? vx1_rx_buf_de[i] ? 0 : ~vx1_rx_buf_vs[i] : vx1_rx_buf_de[i] ? 1 : vx1_rx_buf_vs[i];    
end
endgenerate
